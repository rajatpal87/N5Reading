          ...
          {import.meta.env.PROD && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
              <div className="flex gap-2">
                ...
                <div>
                  <p className="text-xs text-yellow-800 font-medium">Note: YouTube may block server downloads</p>
                  <p className="text-xs text-yellow-700 mt-1">
                    If download fails, please download the video to your computer and use the "Upload Video" tab instead.
                  </p>
                </div>
              </div>
            </div>
